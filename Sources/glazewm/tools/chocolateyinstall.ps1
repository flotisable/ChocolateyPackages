...
$url            = 'https://github.com/glzr-io/glazewm/releases/download/v2.1.0/GlazeWM_x86_v2.1.0.1'
$url64          = 'https://github.com/glzr-io/glazewm/releases/download/v2.1.0/GlazeWM_x64_v2.1.0.1'
